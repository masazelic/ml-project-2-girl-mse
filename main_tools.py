...
#    print("\nExtracted Amino Acids:")
#    print("Amino Acid\tStrand\tPosition")
#    for amino_acid, strand_letter, position in in_contig_amino_acids:
#        print(f"{amino_acid}\t\t{strand_letter}\t\t{position}")
#    print("Contig list of strings:")
#    print(contigs_as_list_of_strings)
...
def index_contigs_in_generated_sequence(residue_table, contigs_as_list_of_strings):
    ...
    # Print the positions and all matching positions
#    print("Positions of Consecutive Amino Acid Strings:")
#    for i, string in enumerate(contigs_as_list_of_strings):
#        print(f"{string}: {positions[i]}")

#    print("\nAll Matching Positions:")
#    print(all_matching_positions)

#    print("\nIndices of Characters Not Matching:")
#    print(not_matching_indices)    
